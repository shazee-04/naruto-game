...
var escape1 = 0;
var startsound = new Audio("hereigo.mp3");
var introworker = 0;
var introcount = 0;
var opacity2 = 100;
...
function idle() {
    idleworker = setInterval(() => {
        ...
        document.getElementById("sprite").src = "Idle.gif";
        clearInterval(idleworker);
    }, 100);
...
var runsound = new Audio("running2.mp3");
...
function runforward() {
    ...
    runfworker = setInterval(() => {
        ...
        document.getElementById("sprite").src = "runforward.gif";
        clearInterval(runfworker);
    }, 100);
...
function runbackward() {
    ...
    runbworker = setInterval(() => {
        ...
        document.getElementById("sprite").src = "runbackward.gif";
        clearInterval(runbworker);
    }, 100);
...
var jumpsound = new Audio("huh.mp3")
var jumpworker = 0;
...
function jump() {
    ...
    jumpworker = setInterval(() => {
        ...
        document.getElementById("sprite").src = "jumpV.gif";
...
var downsound = new Audio("music2.mp3")
downsound.loop = true;
var downworker = 0;
var countworker4 = 0;
var count4 = 0;
...
function down() {
    downworker = setInterval(() => {
        ...
        document.getElementById("sprite").src = "down.gif";
        clearInterval(downworker);
    }, 100);
...
var deadimage = 1;
var deadworker = 0;
var deadsound = new Audio("hit.mp3");
var oversound = new Audio("gameover2.mp3");
...
function dead() {
    deadworker = setInterval(() => {
        ...
        document.getElementById("sprite").style.height = 70 + "vh";
        document.getElementById("sprite").src = "dead" + deadimage + ".png";
    }, 100);
}
